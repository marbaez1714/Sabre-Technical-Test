...
let testTabs = [
    {
        tabName: 'Section 1',
        tabOpen: false,
        tabText: <p> <a href="#">Nam luctus</a>, enim in interdum condimentum, nisl diam iaculis lorem, vel volutpat mi leo sit amet lectus. Praesent non odio bibendum magna bibendum accumsan.</p>
    },
    {
        tabName: 'Section 2',
        tabOpen: false,
